...
const Tokenomics = () => {
  return (
    <div className="bg-[#F46023]">
      <div className="sm:pt-36 pt-8 text-center max-w-prose leading-relaxed sm:leading-relaxed mx-auto hero-h1 text-white text-4xl font-bold sm:text-5xl [text-shadow:_-2px_-2px_0_#000,_2px_-2px_0_#000,_-2px_2px_0_#000,_2px_2px_0_#000]">
        TOKENOMICS
      </div>
      <div className="pt-6 relative">
        ...
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center sm:-mr-60 ml-16">
          <p className="chillax-text text-[#E45421] pb-5 sm:text-2xl break-all text-sm max-w-fit  text-wrap sm:-mt-44 -mt-2">
            TOKEN ADDRESS
          </p>
