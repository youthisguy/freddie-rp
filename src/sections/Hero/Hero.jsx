...
const Hero = () => {
  return (
    <div className="relative sm:mx-auto sm:pt-5 mx-6 max-w-screen-lg sm:max-w-screen-md">
      ...
      <button className="absolute rounded-[30px] -ml-4 mt-6 hero-h1 text-[#F46023] left-4 bg-white border border-black  px-8 py-2 shadow-md hover:bg-gray-100 transition">
        Buy FDV
      </button>
    </div>
  );
