  ...
  return (
    <>
      ...
      <div className="bg-[#EEB678] -mt-4 flex items-center flex-col justify-center">
        <button className="rounded-[35px] mt-8 border-[3px] text-black bg-white border-black px-5 sm:px-7 py-3 sm:py-4 shadow-md hover:bg-gray-100 transition text-sm sm:text-5xl md:text-4xl break-all max-w-[90%] sm:max-w-none cursor-copy">
